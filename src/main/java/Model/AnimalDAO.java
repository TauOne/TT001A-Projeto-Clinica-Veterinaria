...
public class AnimalDAO extends DAO {
    ...
    private Animal buildObject(ResultSet rs) {
        Animal animal = null;
        try {
            animal = new Animal(rs.getInt("codigo"), rs.getString("nome"), rs.getString("nascimento"), rs.getString("sexo").charAt(0), rs.getInt("codEspecie"), rs.getInt("codCliente"));
    ...
    public List retrieveByClientId(int id) {
        return this.retrieve("SELECT * FROM animal WHERE codCliente = " + id);
    }
    ...
    public void update(Animal animal) {
        try {
            ...
            stmt.setString(2, animal.getNascimento());            
